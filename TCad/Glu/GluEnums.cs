...
public enum GluFilter4TypeSGIS
{
    MitchellNetravaliSgi = ((int)100301),
    LagrangianSgi = ((int)100300),
}

public enum GluNurbsDisplay
{
    OutlinePolygon = ((int)100240),
    OutlinePatch = ((int)100241),
    Fill = ((int)GluQuadricDrawStyle.Fill),
}

public enum GluNurbsCallback
{
...
public enum GluNurbsTrim
{
    Map1Trim3 = ((int)100211),
    Map1Trim2 = ((int)100210),
}

public enum GluQuadricDrawStyle
{
    Line = ((int)100011),
...
public enum GluQuadricCallback
{
    Error = ((int)GluNurbsCallback.Error),
}

public enum GluQuadricNormal
{
    None = ((int)100002),
    Flat = ((int)100001),
    Smooth = ((int)100000),
...
public enum GluQuadricOrientation
{
    Outside = ((int)100020),
    Inside = ((int)100021),
}

public enum GluTessCallback
{
